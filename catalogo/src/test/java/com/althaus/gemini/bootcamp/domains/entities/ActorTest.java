    ...
    public class ActorTest {
        ...
        public void testSetFirstNameWithInvalidValue() {
            Exception exception = assertThrows(IllegalArgumentException.class, () -> {
                actor.setFirstName("J0hn");
            });
            String expectedMessage = "El nombre debe estar compuesto por letras";
        ...
        public void testSetLastNameWithInvalidValue() {
            Exception exception = assertThrows(IllegalArgumentException.class, () -> {
                actor.setLastName("D0e");
            });
            String expectedMessage = "El apellido debe estar compuesto por letras";
            String actualMessage = exception.getMessage();
            assertTrue(actualMessage.contains(expectedMessage));
        }

        @Test
        public void testSetFirstNameWithValidValue() {
            actor.setFirstName("Jane");
            assertEquals("Jane", actor.getFirstName());
        }

        @Test
        public void testSetLastNameWithValidValue() {
